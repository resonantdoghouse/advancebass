        ...
        >
          <Card className="h-full hover:border-primary/50 transition-colors">
            <CardHeader>
              ...
              <CardDescription>
                Accurate, adjustable metronome with visual beats and odd time
                signatures.
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        >
          <Card className="h-full hover:border-primary/50 transition-colors">
            <CardHeader>
              ...
              <CardDescription>
                Chromatic tuner with microphone input and reference tones for 4,
        ...
        >
          <Card className="h-full hover:border-primary/50 transition-colors">
            <CardHeader>
              ...
              <CardDescription>
                Interactive fretboard to learn scales and modes on 4, 5, or 6
                string basses.
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        >
          <Card className="h-full hover:border-primary/50 transition-colors">
            <CardHeader>
              ...
              <CardDescription>
                Visual guide to key signatures, relative minors, and scale
                relationships.
              </CardDescription>
            </CardHeader>
            <CardContent>
